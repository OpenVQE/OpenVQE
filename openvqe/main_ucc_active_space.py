...
#   molecule_factory.generate_cluster_ops(molecule_symbol, type_of_generator=type_of_generator,
...
# len_returned_pool, returned_pool = qubitpool.generate_hamiltonian_from_cluster(
#   pool_condition, cluster_ops, nbqbits)
