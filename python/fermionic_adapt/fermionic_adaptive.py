...
import sorted_gradient as fn1


def count(gate, my_list):
...
def print_gradient_lists_and_indices(list_grad):
    ...
    mylist_value_without_0 = fn1.value_without_0(list_grad)
    #         print('mylist_value_without_0:',mylist_value_without_0)

    mylist_index_without_0 = fn1.index_without_0(list_grad)
    #         print('mylist_index_without_0:',mylist_index_without_0)

    sorted_mylist_value_without_0 = fn1.abs_sort_desc(fn1.value_without_0(list_grad))
    #         print('sorted_mylist_value_without_0', sorted_mylist_value_without_0)

    sorted_index = fn1.corresponding_index(
...
def get_statevector(result: "Result", nbqbits: int):
